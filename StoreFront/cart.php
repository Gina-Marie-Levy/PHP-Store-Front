...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
    ...
    foreach ($_SESSION["cart_array"] as $each_item) { 
		...
		$cartOutput .= "<tr>";
		$cartOutput .= '<td><a href="catalog.php?id=' . $item_id . '">' . $productName . '</a><br /><img src="img/' . $item_id . '.jpg" alt="' . $productName. '" width="40" height="52" border="1" /></td>';
...
<title>Cliff's Sporting Goods Your Cart-Gina Levy</title>
